  ...
  return {
    ...
    children: [
      ...
      { type: 'stack', direction: 'column', gap: 4, children: [
          Row("network", { light: '#00AAE4', dark: '#00AAE4' }, "当前连接", netName),
          Row("iphone", { light: '#32D74B', dark: '#32D74B' }, "内网 IP", localIp),
          Row("wifi.router.fill", { light: '#FF9500', dark: '#FF9500' }, "路由网关", gateway),
          { type: 'spacer', length: 2 },
          Row("globe", { light: '#9945FF', dark: '#9945FF' }, "直连公网", pubIp),
          Row("mappin.and.ellipse", { light: '#9945FF', dark: '#9945FF' }, "所在位置", pubLoc),
          Row("antenna.radiowaves.left.and.right", { light: '#9945FF', dark: '#9945FF' }, "运营商", pubIsp)
      ]},
      { type: 'spacer' }
    ]
  };
